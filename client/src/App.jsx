...
import { Community, About, Calendar, Dashboard, Home, MyPlans, Profile, Setting, Support, Team, EcoProfile, NotAuthorizedPage} from './pages';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/ecoProfile/*" element={<ecoProfile />} />
